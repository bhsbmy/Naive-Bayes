...
Compared to the study, this implementation, however, will not include the correlation-based feature selection (CFS) [article]. All vocabularies obtained from the dataset will be used for the studies with the aim of reducing computational complexity.
